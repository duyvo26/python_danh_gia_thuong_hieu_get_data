...
import time
from app.model.db_danh_gia_thuong_hieu import get_request_thuong_hieu_list
from app.model.db_danh_gia_thuong_hieu import insert_request_thuong_hieu_list
from app.model.db_danh_gia_thuong_hieu import check_list_google_end
...
# print((get_request_thuong_hieu_list()))

_id_rq_list = check_list_google_end()

print(_id_rq_list)
print(len(_id_rq_list))